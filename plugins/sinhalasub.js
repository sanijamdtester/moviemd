...
const movs = await fetchApi(`${apilink}/movie/sinhalasub/search?q=${q}`)
var ty = ''
...
let cot = `🔮 *𝖲𝖠𝖭𝖨𝖩𝖠 𝖬𝖣 𝖲𝖨𝖭𝖧𝖠𝖫𝖠𝖲𝖴𝖡 𝖬𝖮𝖵𝖨𝖤 𝖣𝖮𝖶𝖭𝖫𝖮𝖠𝖣𝖤𝖱 * 🔮
...
const move = await fetchApi(`${apilink}/movie/sinhalasub/search?q=${q}`)
let mov = move.result.data
      
    
let cot = `📺 *𝖲𝖠𝖭𝖨𝖩𝖠 𝖬𝖣 𝖲𝖨𝖭𝖧𝖠𝖫𝖠𝖲𝖴𝖡 𝖳𝖵 𝖲𝖧𝖮𝖶 𝖣𝖮𝖶𝖭𝖫𝖮𝖠𝖣𝖤𝖱* 📺
