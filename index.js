...
console.log("Connecting SANIJA-MD BOT 💫...");
...
let up = `🚀 *_SANIJA-MD Connected Successfully!_* ✅ 

--- *😈🎉 _Welcome to SANIJA-MD BOT!_* 🎉😈 

*🔹 PREFIX:* ${prefix}
*🔹 OWNER:* ${ownerNumber}
*🔹 MADE BY:* Sanija Nimtharu
_*🕺Enjoy your time with us!😊*_

*👨‍💻SANIJA MD MADE BY SANIJA NIMTHARU👨‍💻* `;

await conn.sendMessage(ownerNumber + "@s.whatsapp.net", { image: { url: `https://files.catbox.moe/v02why.jpg` }, caption: up })
